...
<script>
  ...
  const earlyRedirectDate = new Date('2026-04-28T00:00:00');
  const lateRedirectDate = new Date('2026-07-16T00:00:00');
...
<div id="event_write">
    ...
    <div class="wrap">
        ...
        <div style="text-align: center; margin-bottom: 20px;">
            <span style="display: inline-block; padding: 8px 24px; background: #FF6B35; color: white; border-radius: 20px; font-size: 14px; font-weight: bold;">스피커 모집 / Speaker Recruitment</span>
        </div>
        -->
        ...
        <div class="write_box" style="position: relative;">
            ...
            <form action="unrealfest_2026_write_proc.php" id="frmWrite" name="frmWrite" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <input type="hidden" name="speaker_type" value="internal" />
...
ex3) Design visualization experts interested in importing data from external tools such as Rhino, Revit, and 3ds Max."><?php echo isset($RData['speaker_target']) ? htmlspecialchars($RData['speaker_target']) : ''; ?></textarea>
                    ...
                    <div class="ch_list_box line">
                        ...
                        <p class="in_info" style="margin-top: 10px; color: #FDFF70;">
                            <span class="lang-text" data-ko="*추후 별도로 제공되는 '발표자 동의서'에 서명해 주셔야 합니다." data-en="* You will be required to review and sign a &quot;Speaker Agreement&quot; which will be provided separately at a later date.">*추후 별도로 제공되는 '발표자 동의서'에 서명해 주셔야 합니다.</span>
                        </p>
                    </div>
                    ...
                    <div class="btn_box_fot">
                            <button type="button"  onclick="location.href = '/unrealfest26_speaker.php';" class="btn_type1"><span class="lang-text" data-ko="취소" data-en="Cancel">취소</span></button>
                            <button type="button" class="btn_type2"><span class="lang-text" data-ko="제출하기" data-en="Submit">제출하기</span></button>
                    </div>
                        <?php } ?>
